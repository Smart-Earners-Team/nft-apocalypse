...
export const Utility = () => {
    ...
    return (
        <div id='utility' className='items-center flex flex-wrap md:flex-nowrap px-10 py-3 gap-5'>
            ...
            <div className='md:w-[50%]'>
                ...
                <div className='text-2xl py-2 text-center'>The NFT Apocalypse Utility Token</div>
