...
const Layout:React.FC<GlobalTypes> = ( {
    ...
    <AppWrapper>
        ...
        <span className='top-[15vw] absolute w-[45vw] h-[50vw] md:h-[80vw] bg-[#89DAF3]/25 blur-[100px] md:blur-[250px]' />

        <span className='top-[30vw] md:top-[15vw] absolute left-[50vw] w-[45vw] h-[50vw] md:h-[80vw] bg-[#EC1F38]/25 blur-[100px] md:blur-[250px]' />
